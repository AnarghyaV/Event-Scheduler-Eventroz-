...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  tblevents(EventName,Cost) value('$sername','$cost')");
    if ($query) {
